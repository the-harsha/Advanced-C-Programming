...
namespace ObserverDesignPatternEvents
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //The central hub that publishes visitor entry/exit updates
            SecuritySurveillanceHub securitySurveillanceHub = new SecuritySurveillanceHub();

            // Observers for specific employees
            ...
            // Observer for building security
            SecurityNotify securityNotify = new SecurityNotify();

            // Subscribe observers to the observable hub
    ...
    // Represents a company employee who receives notifications
    // about visitors assigned to them.
    ...
    // Interface defining required employee fields.
    ...
    // Base class for all observers. Implements IObserver<ExternalVisitor>.
    // Stores a list of visitors relevant to the observer.
    ...
    /// <summary>
    /// Observer that notifies a specific employee when THEIR visitors 
    ...
    public class EmployeeNotify : Observer
    {
        ...
        //constructor that injects the IEmployee in the EmployeeNotify class
        ...
        /// <summary>
        /// Handles updates whenever a visitor arrives or leaves.
        /// Only processes visitors assigned to this employee.
        /// </summary>
